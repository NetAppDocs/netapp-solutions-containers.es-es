...
summary: Registro de cambios recientes en el material complementario de las soluciones de contenedores de NetApp . 
---
= Novedades en las soluciones de contenedores de NetApp
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
[role="lead"]
Conozca las novedades en soluciones de contenedores.
...
* Soluciones de contenedores de NetApp
